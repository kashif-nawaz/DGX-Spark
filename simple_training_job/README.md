...
In the previous document we have described, how to setup DGX Sparks 4 Nodes cluster across multiswitch topology. 
We have also learned how to perform NCCL performance testing using various collectives. In this guide we will learn how to perform a training job on 4 Nodes NVIDIA DGX Spark (GB10 Grace-Blackwell) cluster.
